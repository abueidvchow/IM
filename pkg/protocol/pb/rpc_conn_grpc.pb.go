...
const (
	Connect_DeliverMessage_FullMethodName      = "/pb.Connect/DeliverMessage"
	Connect_DeliverGroupMessage_FullMethodName = "/pb.Connect/DeliverGroupMessage"
)
...
type ConnectClient interface {
	...
	// 群聊消息投递
	DeliverGroupMessage(ctx context.Context, in *DeliverMessageGroupReq, opts ...grpc.CallOption) (*emptypb.Empty, error)
}
...
func (c *connectClient) DeliverGroupMessage(ctx context.Context, in *DeliverMessageGroupReq, opts ...grpc.CallOption) (*emptypb.Empty, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(emptypb.Empty)
	err := c.cc.Invoke(ctx, Connect_DeliverGroupMessage_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type ConnectServer interface {
	...
	// 群聊消息投递
	DeliverGroupMessage(context.Context, *DeliverMessageGroupReq) (*emptypb.Empty, error)
...
func (UnimplementedConnectServer) DeliverGroupMessage(context.Context, *DeliverMessageGroupReq) (*emptypb.Empty, error) {
	return nil, status.Errorf(codes.Unimplemented, "method DeliverGroupMessage not implemented")
}
...
func _Connect_DeliverGroupMessage_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(DeliverMessageGroupReq)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(ConnectServer).DeliverGroupMessage(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: Connect_DeliverGroupMessage_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(ConnectServer).DeliverGroupMessage(ctx, req.(*DeliverMessageGroupReq))
	}
	return interceptor(ctx, in, info, handler)
}
...
var Connect_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "DeliverGroupMessage",
			Handler:    _Connect_DeliverGroupMessage_Handler,
		},
	},
	Streams:  []grpc.StreamDesc{},
	Metadata: "rpc_conn.proto",
}
