...
// ACK消息类型，根据Input/Output的type解析出是ACK，再根据ACKType判断是 ACK 的什么消息
type ACKType int32

const (
	ACKType_AT_UNKNOWN ACKType = 0
	ACKType_AT_UP      ACKType = 1 // 服务端确认客户端发来的消息
	ACKType_AT_PUSH    ACKType = 2 // 客户端确认服务端发来的消息
...
// 根据顶层消息 type 解析得到
// 客户端中发送场景：
// TODO 1. 客户端中收到 PushMsg 类型消息，向服务端回复 AT_Push 类型的 ACK，表明已收到
// 服务端中发送场景：
...
type ACKMsg struct {
	...
	Type     ACKType `protobuf:"varint,1,opt,name=type,proto3,enum=pb.ACKType" json:"type,omitempty"` // 收到什么类型的ACK
	ClientId int64   `protobuf:"varint,2,opt,name=clientId,proto3" json:"clientId,omitempty"`
	Seq      int64   `protobuf:"varint,3,opt,name=seq,proto3" json:"seq,omitempty"` // 上行消息推送时回复最新的 seq
}
...
var file_message_proto_rawDesc = []byte{
	...
	0x68, 0x61, 0x73, 0x4d, 0x6f, 0x72, 0x65, 0x22, 0x57, 0x0a, 0x06, 0x41, 0x43, 0x4b, 0x4d, 0x73,
	0x67, 0x12, 0x1f, 0x0a, 0x04, 0x74, 0x79, 0x70, 0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32,
	0x0b, 0x2e, 0x70, 0x62, 0x2e, 0x41, 0x43, 0x4b, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79,
	...
	0x22, 0x20, 0x0a, 0x08, 0x4c, 0x6f, 0x67, 0x69, 0x6e, 0x4d, 0x73, 0x67, 0x12, 0x14, 0x0a, 0x05,
	0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0c, 0x52, 0x05, 0x74, 0x6f, 0x6b,
	0x65, 0x6e, 0x22, 0x0e, 0x0a, 0x0c, 0x48, 0x65, 0x61, 0x72, 0x74, 0x62, 0x65, 0x61, 0x74, 0x4d,
	0x73, 0x67, 0x2a, 0x3a, 0x0a, 0x0b, 0x53, 0x65, 0x73, 0x73, 0x69, 0x6f, 0x6e, 0x54, 0x79, 0x70,
	0x65, 0x12, 0x0e, 0x0a, 0x0a, 0x53, 0x54, 0x5f, 0x55, 0x4e, 0x4b, 0x4e, 0x4f, 0x57, 0x4e, 0x10,
	0x00, 0x12, 0x0d, 0x0a, 0x09, 0x53, 0x54, 0x5f, 0x53, 0x49, 0x4e, 0x47, 0x4c, 0x45, 0x10, 0x01,
	0x12, 0x0c, 0x0a, 0x08, 0x53, 0x54, 0x5f, 0x47, 0x52, 0x4f, 0x55, 0x50, 0x10, 0x02, 0x2a, 0x48,
	...
	,
